  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (isNewUser) {
        ...
        // Returning user - redirect to main app
        navigate("/");
      }
    } catch (error) {
        ...
        <div className="bg-neutral-900/60 backdrop-blur-sm rounded-3xl p-8 border border-neutral-800 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="text-right">
              <a href="/forgot-password" className="text-sm text-neutral-400 hover:text-white transition-colors">
                Forgot password?
              </a>
            </div>
          ...
          <div className="mt-8">
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center">
                <span className="mt-1 px-4 text-sm text-gray-400">Or continue with</span>
              </div>
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-400">
              ...
              <Link 
                to="/signup" 
                className="text-white hover:text-gray-300 font-medium transition-colors focus:outline-none"
              >
                Sign up
              </Link>
            </p>
